...
const { actions, reducer } = createSlice({
  ...
  reducers: {
    ...
    closeShowFileUploadDialog: noPayload<ShowSliceState>((state) => {
      state.uploadData.uploaded = false;
    }),
    ...
    openShowFileUploadDialog: noPayload<ShowSliceState>((state) => {
      state.uploadData.uploaded = true;
    }),
